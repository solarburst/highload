...
interface Group_by extends Data_For_Group {
    items: Data_For_Group[];
    groupField: string;
    groupValue: string;
}

function generateData(amount: number): Data_For_Group[] {
    return Array.from({length: amount}, (v, i): Data_For_Group => ({
            id: i,
...
// Generate demo data
const data: Data_For_Group[] = generateData(100000);
